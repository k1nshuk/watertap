...
from watertap.tools.parameter_sweep import LinearSample, ParameterSweep
...
def run_case(number_of_stages, nx, comm_size):
    """
    ...
    ps = ParameterSweep(
            ...
            h5_results_file_name=f"output/scaling/results_scaling_{comm_size}_{nx}.h5",
            optimize_function=lsrro.solve,
...
if __name__ == "__main__":
    ...
    num_stages = 2
    ps, global_results_dict = run_case(num_stages, num_samples, comm_size)
